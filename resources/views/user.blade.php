...
<body>
    ...
    <form action="{{route('store')}}" method="post">
        ...
        {{-- dependent country-state-city dropdown  --}}
          <div class="form-group">
          ...
          <div class="form-group">
            <select name="state_id" id="state-dd" class="form-control"></select>
          </div>
          <div class="form-group">
            <select name="city_id" id="city-dd" class="form-control"></select>
          </div>
